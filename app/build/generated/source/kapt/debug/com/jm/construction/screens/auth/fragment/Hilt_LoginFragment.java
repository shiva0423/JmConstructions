package com.jm.construction.screens.auth.fragment;
 ...
 */
public abstract class Hilt_LoginFragment<T extends ViewDataBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginFragment(int layoutResId) {
    super(layoutResId);
  }
