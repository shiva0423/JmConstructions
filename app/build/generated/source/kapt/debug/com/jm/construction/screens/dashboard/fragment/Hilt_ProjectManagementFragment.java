package com.jm.construction.screens.dashboard.fragment;
...
import com.jm.construction.baseClasses.BaseFragment;
 ...
 */
public abstract class Hilt_ProjectManagementFragment<T extends ViewDataBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProjectManagementFragment(int layoutResId) {
    super(layoutResId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProjectManagementFragment_GeneratedInjector) this.generatedComponent()).injectProjectManagementFragment(UnsafeCasts.<ProjectManagementFragment>unsafeCast(this));
    }
  }
